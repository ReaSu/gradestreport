 ...
 */
    ...
    $row[] = new tabobject('graderreport',
                           $CFG->wwwroot.'/grade/report/gradest/index.php?id='.$courseid,
                           get_string('pluginname', 'gradereport_gradest'));
    if (has_capability('moodle/grade:manage',$tabcontext ) ||
        ...
        $row[] = new tabobject('preferences',
                               $CFG->wwwroot.'/grade/report/gradest/preferences.php?id='.$courseid,
