YUI.add('moodle-gradereport_gradest-gradereporttable', function (Y, NAME) {
 ...
 *
 * @module    moodle-gradereport_gradest-gradereporttable
...
Y.namespace('M.gradereport_gradest').ReportTable = ReportTable;
Y.namespace('M.gradereport_gradest').init = function(config) {
    return new Y.M.gradereport_gradest.ReportTable(config);
};
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
 ...
 *
 * See {{#crossLink "M.gradereport_gradest.ReportTable"}}{{/crossLink}} for details.
 *
 * @namespace M.gradereport_gradest
...
FloatingHeaders.prototype = {
    ...
    setupFloatingHeaders: function() {
        ...
        Y.Global.on('moodle-gradereport_gradest:resized', this._handleResizeEvent, this);
...
Y.Base.mix(Y.M.gradereport_gradest.ReportTable, [FloatingHeaders]);
