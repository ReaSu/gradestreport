...
$PAGE->set_url(new moodle_url('/grade/report/gradest/preferences.php', array('id'=>$courseid)));
...
if (!$mform->is_cancelled() && $data = $mform->get_data()) {
    ...
    redirect($CFG->wwwroot . '/grade/report/gradest/index.php?id='.$courseid); // message here breaks accessability and is sloooowww
    exit;
}

if ($mform->is_cancelled()){
    redirect($CFG->wwwroot . '/grade/report/gradest/index.php?id='.$courseid);
}

print_grade_page_head($courseid, 'settings', 'grader', get_string('preferences', 'gradereport_gradest'));
