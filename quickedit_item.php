...
$url = new moodle_url('/grade/report/gradest/quickedit_item.php', array('id'=>$courseid, 'itemid'=>$itemid));
if ($page !== 0) {
    $url->param('page', $page);
}
if ($perpage !== 0) {
...
$report = new grade_report_gradest($courseid, $gpr, $context, $page);
...
$reportname = get_string('quickedititem', 'gradereport_gradest', $a);
