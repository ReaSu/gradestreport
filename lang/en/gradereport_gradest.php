...
/**
 * Strings for component 'gradereport_gradest', language 'en'
 *
...
$string['pluginname'] = 'Gradest report';
...
$string['privacy:metadata:preference:grade_report_gradest_collapsed_categories'] = 'List of gradebook categories to be collapsed';
...
$string['privacy:request:preference:grade_report_gradest_collapsed_categories'] = 'You have some gradebook categories collapsed in the "{$a->name}" course';
